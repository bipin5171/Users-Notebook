...
const onChange = (e) => {
  ...
  return (
    <div className="container mt-2">
      ...
      <div className="my-3">
    <label htmalFor="name" className="form-label">Name</label>
  ...
  <div className="mb-3">
    <label htmalFor="password" className="form-label">Password</label>
    <input type="password" className="form-control" id="password" name="password" onChange={onChange} minLength={3} required/>
  </div>
  <div className="mb-3">
    <label htmalFor="cpassword" className="form-label">Confirm Password</label>
